    ...
    <ul className='px-[20px]'>
      <li className='flex w-full flex-row items-center my-3'>
        ...
        <span className='basis-2/3 text-right'>
          {props.etc.earlyRedemptionFee === 'null'
            ? '기관 문의'
      ...
      <li className='flex w-full flex-row items-center my-3'>
        ...
        <span className='basis-2/3 text-right'>
          {props.etc.etcNode === 'null' ? '기관 문의' : props.etc.etcNode}
        </span>
      </li>
      <li className='flex w-full flex-row items-center my-3'>
        <span className='basis-1/3 font-bold text-[18px]'>가입(신청)방법</span>
        <span className='basis-2/3 text-right'>
          {props.etc.joinMethod === 'null' ? '기관 문의' : props.etc.joinMethod}
        </span>
      </li>
      <li className='flex w-full flex-row items-center my-3'>
        ...
        <span className='basis-2/3 text-right'>
          {props.etc.primeCondition === 'null'
            ? '기관 문의'
            : props.etc.primeCondition}
        </span>
      </li>{' '}
      <li className='flex w-full flex-row items-center my-3'>
        <span className='basis-1/3 font-bold text-[18px]'>제공기관명</span>
        <span className='basis-2/3 text-right'>
          {props.etc.provider === 'null' ? '기관 문의' : props.etc.provider}
        </span>
      </li>
      <li className='flex w-full flex-row items-center my-3'>
        <span className='basis-1/3 font-bold text-[18px]'>취급기관</span>
        <span className='basis-2/3 text-right'>
          {props.etc.userOffice === 'null' ? '기관 문의' : props.etc.userOffice}
        </span>
      </li>
    </ul>
  );
